          ...
          <div className="flex flex-col lg:flex-row">
            ...
            <div className="lg:w-1/2 p-6 lg:p-8 flex flex-col justify-start border-t lg:border-t-0 lg:border-l border-gray-100">
              ...
              <button
                ...
                className="btn-primary py-4 text-lg rounded-xl mb-2 w-full flex items-center justify-center gap-2 bg-black hover:bg-gray-900 text-white font-bold shadow-lg cursor-pointer"
              >
